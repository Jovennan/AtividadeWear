...
class BigPictureSocialIntentService extends IntentService {
    ...
    public BigPictureSocialIntentService() {
        ...
        mParticipants.add("Agostinho Cachaceiro");
        mParticipants.add("Ionay Silva");
...
//                MockDatabase.getBigPictureStyleData();
        ...
        RemoteInput remoteInput =
                new RemoteInput.Builder(BigPictureSocialIntentService.EXTRA_COMMENT)
                        .setLabel(replyLabel)
                        .setChoices(this.mPossiblePostResponses)
                        .build();
        ...
        for (String name : this.mParticipants) {
